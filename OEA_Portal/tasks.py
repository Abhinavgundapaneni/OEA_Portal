...
from core.models import InstallationLogs
from auth.AzureClient import AzureClient
from core.services.AzureResourceProvisionService import AzureResourceProvisionService
from core.services.SynapseManagementService import SynapseManagementService
import logging

class OEAInstaller(current_app.Task):
    name = 'tasks.oea_installer'
